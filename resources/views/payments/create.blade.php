    ...
    <div class="container-fluid p-0">
        <div class="row mb-1">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>Add Payment System (VPS)</strong></h3>
            </div>
                    ...
                    <form method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="form-control" id="billNumber" placeholder="Bank Name">
                                @error('bank_name')
                                    <div class="small text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="payment_date" value="{{ old('payment_date') }}" class="form-control flatpickr" id="billDate" placeholder="Payment Date">
                                @error('payment_date')
                                    <div class="small text-danger">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="number" step="any" name="amount" value="{{ old('amount') }}" class="form-control" id="Amount" placeholder="Amount">
                                @error('amount')
                                    <div class="small text-danger">
                                        {{ $message }}
                                    </div>
