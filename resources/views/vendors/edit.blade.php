                ...
                <form method="post" action="{{ route('vendors.update', $vendor->id) }}">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea name="description" class="form-control" id="description" placeholder="Description" rows="2">{{ old('description') ? old('description') : $vendor->description }}</textarea>
                            @error('description')
                                <div class="small text-danger">
                                    {{ $message }}
                                </div>
